...
import FristImage from "@/assets/compare01.jpeg";
import SecondImage from "@/assets/compare02.jpeg";
    ...
    <section className="bg-[#f8f8f6] py-20 sm:py-28">
      ...
      >
        <div className="text-center lg:text-left">
          ...
          <h2 className="mt-5 font-serif text-3xl leading-tight tracking-tight text-zinc-900 sm:text-4xl">
            Transformation, guided by precision.
          </h2>
          <p className="mx-auto mt-5 max-w-md text-base leading-7 text-zinc-600 lg:mx-0">
            A closer look at the changes possible when thoughtful planning,
            advanced techniques, and personal care work together.
          </p>
          <p className="mt-8 text-xs leading-5 text-zinc-500">
            Move the slider to explore the result. Each treatment plan is
